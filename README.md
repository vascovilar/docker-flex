...
---------------------------
  ...
  1. open redis commander in a browser `http://localhost:8081` and login user `root` with pass `root`
  1. open rabbit admin in a browser `http://localhost:15672` and login user `root` with pass `root`
